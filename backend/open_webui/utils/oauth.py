    ...
    try:
        ...
        if oauth_server_metadata is None or not oauth_server_metadata.authorization_endpoint:
            ...
            raise Exception(
                ...
                'expose RFC 8414 / RFC 9728 discovery documents so DianeGPT can '
...
class OAuthManager:
    ...
    async def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(f'All groups available in DianeGPT: {[g.name for g in all_available_groups]}')
